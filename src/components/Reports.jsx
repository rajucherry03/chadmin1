    ...
    switch (selectedReport) {
      ...
      case 'fee-collection':
        report.data = filteredStudents.map(student => ({
          ...
          outstandingFee: (student.totalFee || 0) - (student.paidFee || 0),
      ...
      case 'hostel-occupancy':
        report.data = filteredStudents.map(student => ({
          ...
          name: student.name || student.firstName + ' ' + student.lastName,
          rollNo: student.rollNo,
          hostelBlock: student.hostelBlock || 'N/A',
          roomNumber: student.roomNumber || 'N/A',
          checkInDate: student.checkInDate || 'N/A',
          status: student.hostelStatus || 'Not Allocated'
        }));
        break;
      ...
      case 'admission-trends':
        ...
        report.data = Object.entries(yearStats).map(([year, count]) => ({
          year,
          count,
          percentage: ((count / filteredStudents.length) * 100).toFixed(2)
        }));
        break;

...
const BulkImport = ({ onClose, onSuccess }) => {
  ...
  const availableFields = [
    ...
    { name: "department", label: "Department", type: "select", required: false, options: ["Computer Science & Engineering", "Electrical & Electronics Engineering", "Mechanical Engineering", "Civil Engineering", "Management Studies"] },
    { name: "year", label: "Year", type: "select", required: false, options: ["I", "II", "III", "IV"] },
    { name: "section", label: "Section", type: "select", required: false, options: ["A", "B", "C"] },

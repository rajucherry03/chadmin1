  ...
  const transportRoutes = [
    {
      ...
      capacity: 45,
      occupied: 38,
      stops: ["Central Station", "Mall Road", "University"],
    ...
    },
    {
      ...
      capacity: 40,
      occupied: 35,
      stops: ["Airport Road", "Tech Park", "University"],
    ...
    },
    {
      ...
      capacity: 35,
      occupied: 28,
      stops: ["Industrial Area", "Residential Colony", "University"],
            ...
            <div key={route.id} className="border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-2 mb-3">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{route.occupied}/{route.capacity}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Timing:</span>
                  <span className="font-medium text-xs">{route.timing}</span>
                </div>
              </div>
              ...
              <div className="text-xs text-gray-500 text-center mb-3">
                {((route.occupied / route.capacity) * 100).toFixed(1)}% occupied
              </div>

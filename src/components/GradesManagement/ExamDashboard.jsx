      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-lg">Here's what's happening in your Grades Management System</p>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{examStats.completedExams}</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">{examStats.averageAttendance}%</p>
          ...
          <div className="p-6">
            <div className="space-y-4">
              {upcomingExams.map((exam) => (
                <div key={exam.id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-all duration-200">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900">{exam.courseCode} - {exam.courseName}</h4>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-gray-600">{exam.date} at {exam.time}</span>
                    </div>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <span className="text-xs text-gray-500">Instructor: {exam.instructor}</span>
          ...
          <div className="p-6">
            <div className="space-y-4">
              {pendingTasks.map((task) => (
                <div key={task.id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-all duration-200">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-600">{task.instructor}</span>
                      </div>
                    </div>
        ...
        <div className="p-6">
          <div className="space-y-4">
            {recentActivities.map((activity) => (
              <div key={activity.id} className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-200">
        ...
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <button className="flex items-center space-x-3 p-4 bg-green-50 rounded-xl hover:bg-green-100 transition-all duration-200 group">
              ...
              <div className="text-left">
                <p className="font-semibold text-gray-900">Calculate Grades</p>
                <p className="text-sm text-gray-600">Process final grades</p>
              </div>
            </button>
            ...
            <button className="flex items-center space-x-3 p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition-all duration-200 group">
              ...
              <div className="text-left">
                <p className="font-semibold text-gray-900">Publish Results</p>
                <p className="text-sm text-gray-600">Release to students</p>
              </div>
            </button>
          </div>
        </div>

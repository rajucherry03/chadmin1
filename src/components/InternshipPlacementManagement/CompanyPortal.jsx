...
import { faBuilding, faBriefcase, faUsers, faChartLine } from '@fortawesome/free-solid-svg-icons';

const CompanyPortal = ({ userRole, companies, internships, applications, loading, error }) => {
  if (loading) {
    return (
      <div className="p-6">
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage your company's internship and placement activities</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white p-4 rounded-lg shadow-sm border">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Hired Students</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors">
            <div className="text-center">
              <FontAwesomeIcon icon={faBriefcase} className="text-blue-600 text-2xl mb-2" />
              <p className="font-medium text-gray-900">Post New Internship</p>
              <p className="text-sm text-gray-600">Create a new internship opportunity</p>
            </div>
          </button>
          
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-green-500 hover:bg-green-50 transition-colors">
            <div className="text-center">
              <FontAwesomeIcon icon={faUsers} className="text-green-600 text-2xl mb-2" />
